...
It is well known that the coding transcriptome response has been studies extensively, but no investigation was conducted regarding changes in non-coding transcriptome of fish exposed to MC-LR. There is another manuscript in preparation regarding protein-coding transcriptome.

Lack of genome sequence has made the study of transcriptomic data demanding task. Some difficulties can be overcame by _de novo_ genome assembly. 

When no genome sequence is available, transcriptome seqeuencing is an effective way to obtain large numbers of molecular markers and identify transcripts involved in specific biological process.
