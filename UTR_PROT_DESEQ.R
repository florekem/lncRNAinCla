...
write.csv(wyniki, file="/mnt/sdb1/Project_Sieja_MCLR_52/2_pipeline/7_counting_transcripts/noncoding_novel/NOVEL_deseq2_result_from_R_1d.csv", row.names=FALSE)
